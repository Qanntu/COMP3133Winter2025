...
app.get('/employees/firstname/:name', async (req, res) => {
  ...
  // new RegExp(value, 'i') for case insensitive search
  // const employees = await employeeModel.find({firstname : new RegExp(name, 'i')});
  
  //Using Virtual Field Name
  // console.log(`virtual field name - employees[0].fullname ${employees[0].fullname}`)

  //Using Instance method
  // console.log(`virtual field name - employees[0].getFullName() ${employees[0].getFullName()}`)

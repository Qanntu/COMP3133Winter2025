...
stud1.showDetails();
let stud2 = new Student_1.default(2, "Jane", "Doe", 85.0);
stud2.showDetails();
...
let ptEmp1 = new PartTimeEmployee_1.default(1, "John", "Doe", "IT", 160, 25);
ptEmp1.showDetails();
...
let ptEmp2 = new PartTimeEmployee_1.default(2, "Jane", "Doe", "HR", 180, 30);
ptEmp2.showDetails();
/*
For lab submission:

1. .zip file of project
2. WORD doc with screenshots of the output
